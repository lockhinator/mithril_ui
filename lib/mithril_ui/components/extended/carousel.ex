defmodule MithrilUI.Components.Carousel do
  ...
  def carousel(assigns) do
    ...
    <div id={@id} class={["relative w-full", @class]} data-carousel-active="0" {@rest}>
      ...
      <!-- Indicators -->
      <div :if={@show_indicators && @total > 1} class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3">
  ...
  def carousel_controls(assigns) do
    ...
    <button
      type="button"
      class={["absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none", @class]}
      phx-click={prev_slide(@id, @total)}
    >
      <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 group-hover:bg-white/50 group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
        <svg class="w-4 h-4 text-white rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
    ...
    <button
      type="button"
      class={["absolute top-0 end-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none", @class]}
      phx-click={next_slide(@id, @total)}
    >
      <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 group-hover:bg-white/50 group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
        <svg class="w-4 h-4 text-white rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
